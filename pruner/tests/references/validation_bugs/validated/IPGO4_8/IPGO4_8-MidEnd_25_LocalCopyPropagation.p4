                ...
                {
                    {
                        ...
                        val_0 = (!true ? val_0 : (bit<3>)h.Wedn.eth_type);
                        bound_0 = (!true ? bound_0 : 3w1);
                        hasReturned = (!true ? hasReturned : false);
                        tmp_6 = (!true ? tmp_6 : (cond_0 ? val_0 : tmp_6));
                        tmp_6 = (!true ? tmp_6 : (cond_0 ? val_0 : bound_0));
                    }
                }
            }
            hasReturned = (!true ? hasReturned : true);
            retval = (!true ? retval : tmp_6);
            tmp = (!true ? tmp : retval);
            tmp_0 = (!true ? tmp_0 : tmp);
            h.klMg[tmp_0].eth_type = (!true ? h.klMg[tmp_0].eth_type : h.Wedn.eth_type);
        }
        h.klMg[(3w0 < 3w1 ? 3w0 : 3w1)].dst_addr = h.CrEE.dst_addr;
    }
    apply {
        {
            if (3w1 < 3w1) {
