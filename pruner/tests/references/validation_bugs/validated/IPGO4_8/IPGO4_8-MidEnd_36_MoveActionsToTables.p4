...
control ingress(inout Headers h) {
    ...
    @hidden action IPGO4_8l3() {
        tmp_14 = 3w1;
        h.klMg[tmp_14].eth_type = 16w33216;
    }
    @hidden action IPGO4_8l92() {
        h.eth_hdr.src_addr = 48w204206464434860;
    }
    @hidden table tbl_IPGO4_8l3 {
        actions = {
            IPGO4_8l3();
        }
        const default_action = IPGO4_8l3();
    }
    @hidden table tbl_oQUdL {
        actions = {
            oQUdL();
        }
        const default_action = oQUdL();
    }
    @hidden table tbl_IPGO4_8l92 {
        actions = {
            IPGO4_8l92();
        }
        const default_action = IPGO4_8l92();
    }
    apply {
        tbl_IPGO4_8l3.apply();
        tbl_oQUdL.apply();
        tbl_IPGO4_8l92.apply();
    }
}
