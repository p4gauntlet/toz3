...
control ingress(inout Headers h) {
    ...
    apply {
        ...
        aVQXxV = 4w14;
        oQUdL({ 128w340282366920938463463374607431595471583, 4w12, true, 8w41, 64w18446744073709551615 });
        ethernet_t qbQNsp = (ethernet_t){dst_addr = 48w182822655386268,src_addr = 48w25566851739804,eth_type = 16w37651 |+| h.klMg[1].eth_type};
