...
P4Declaration("simple_tbl_0", P4Table("simple_tbl", key=[(P4Member(P4Member("hdr", "eth_hdr"), "src_addr"), "exact"), ], actions=[MethodCallExpr("NoAction", [], ), MethodCallExpr("set_mac_0", [], ), ], default_action=MethodCallExpr("NoAction", [], ), immutable=False)), ]
        ))
    )
    prog_state.declare_global(
        ControlDeclaration(P4Control(
