...
def p4_program(prog_state):
    ...
    prog_state.declare_global(
        HeaderType("short", prog_state, fields=[("f", z3.BitVecSort(32)), ], type_params=[])
    )
    prog_state.declare_global(
        StructType("alt_t", prog_state, fields=[("valid", z3.BitVecSort(1)), ("port", z3.BitVecSort(7)), ], type_params=[])
    )
    prog_state.declare_global(
        StructType("row_t", prog_state, fields=[("alt0", "alt_t"), ("alt1", "alt_t"), ], type_params=[])
    )
    prog_state.declare_global(
        StructType("parsed_packet_t", prog_state, fields=[], type_params=[])
    )
    prog_state.declare_global(
        StructType("local_metadata_t", prog_state, fields=[("s", "short"), ("row", "row_t"), ], type_params=[])
    )
    prog_state.declare_global(
        ControlDeclaration(P4Parser(
            ...
            type_params=[],
            params=[
                P4Parameter("none", "pk", "packet_in", None),
                P4Parameter("out", "hdr", "parsed_packet_t", None),
                P4Parameter("inout", "local_metadata", "local_metadata_t", None),
                P4Parameter("inout", "standard_metadata", "standard_metadata_t", None),],
            const_params=[],
            local_decls=[],
            body=ParserTree([
    ...
    prog_state.declare_global(
        ControlDeclaration(P4Control(
            ...
            type_params=[],
            params=[
                P4Parameter("inout", "hdr", "parsed_packet_t", None),
                P4Parameter("inout", "local_metadata", "local_metadata_t", None),
                P4Parameter("inout", "standard_metadata", "standard_metadata_t", None),],
            const_params=[],
            body=BlockStatement([
                MethodCallStmt(MethodCallExpr(P4Member(P4Member("local_metadata", "s"), "setValid"), [], )),
                AssignmentStatement(P4Member(P4Member("local_metadata", "s"), "f"), 0),
                AssignmentStatement(P4Member(P4Member("local_metadata", "row"), "alt0"), P4Member(P4Member("local_metadata", "row"), "alt1")),
                AssignmentStatement(P4Member(P4Member(P4Member("local_metadata", "row"), "alt0"), "valid"), 1),
                AssignmentStatement(P4Member(P4Member(P4Member("local_metadata", "row"), "alt1"), "port"), P4add(P4Member(P4Member(P4Member("local_metadata", "row"), "alt1"), "port"), 1)),
                MethodCallStmt(MethodCallExpr("clone3", [], P4Member("CloneType", "I2E"), 0, P4Member("local_metadata", "row"), )),]
            ),
            local_decls=[]
        ))
    )
    ...
    prog_state.declare_global(
        ControlDeclaration(P4Control(
            ...
            params=[
                P4Parameter("none", "b", "packet_out", None),
                P4Parameter("in", "hdr", "parsed_packet_t", None),],
            const_params=[],
            body=BlockStatement([]
            ),
            local_decls=[]
    ...
    prog_state.declare_global(
        InstanceDeclaration("main", "V1Switch", ConstCallExpr("parse", ), ConstCallExpr("verifyChecksum", ), ConstCallExpr("ingress", ), ConstCallExpr("egress", ), ConstCallExpr("compute_checksum", ), ConstCallExpr("deparser", ), )
    )
