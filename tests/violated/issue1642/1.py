    ...
    prog_state.declare_global(
        ControlDeclaration(P4Control(
            ...
            body=BlockStatement([
                ...
                AssignmentStatement(P4Member(P4Member("local_metadata", "row"), "alt1"), P4Member(P4Member("local_metadata", "row"), "alt0")),
                AssignmentStatement(P4Member(P4Member(P4Member("local_metadata", "row"), "alt0"), "valid"), 1),
                AssignmentStatement(P4Member(P4Member(P4Member("local_metadata", "row"), "alt0"), "port"), P4add(P4Member(P4Member(P4Member("local_metadata", "row"), "alt0"), "port"), 1)),
