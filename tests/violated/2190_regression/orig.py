...
def p4_program(prog_state):
    ...
    prog_state.declare_global(
        ControlDeclaration(P4Control(
            ...
            const_params=[],
            body=BlockStatement([
                ValueDeclaration("tmp", P4Initializer(z3.BitVecVal(1, 8), z3.BitVecSort(8)), z3_type=z3.BitVecSort(8)),
                AssignmentStatement(P4Member(P4Member("hdr", "h"), "a"), P4rshift(P4rshift("tmp", z3.BitVecVal(3, 2)), z3.BitVecVal(1, 2))),]
            ),
            local_decls=[]
        ))
    )
