...
def p4_program(prog_state):
    ...
    prog_state.declare_global(
        P4Declaration("f", P4Function("f", return_type=z3.BitVecSort(8), params=[
            P4Parameter("in", "x", z3.BitVecSort(8), None),
            P4Parameter("in", "y", z3.BitVecSort(8), None),
            P4Parameter("out", "z", z3.BitVecSort(8), None),],         body=BlockStatement([
            AssignmentStatement("z", P4bor("x", "y")),
            P4Return(z3.BitVecVal(4, 8)),]
        )        )        )
    )
    prog_state.declare_global(
        P4Declaration("g", P4Function("g", return_type=z3.BitVecSort(8), params=[
            P4Parameter("out", "w", z3.BitVecSort(8), None),],         body=BlockStatement([
            AssignmentStatement("w", z3.BitVecVal(3, 8)),
            P4Return(z3.BitVecVal(1, 8)),]
        )        )        )
    )
    prog_state.declare_global(
        ControlDeclaration(P4Control(
            ...
            body=BlockStatement([
                BlockStatement([
                    AssignmentStatement("tmp", MethodCallExpr("g", [], P4Member(P4Member("h", "h"), "a"), )),
                    AssignmentStatement("tmp_0", "tmp"),
                    MethodCallStmt(MethodCallExpr("f", [], P4Member(P4Member("h", "h"), "a"), "tmp_0", P4Member(P4Member("h", "h"), "b"), )),]
                ),]
            ),
            local_decls=[
