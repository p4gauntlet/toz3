...
def p4_program(prog_state):
    ...
    prog_state.declare_global(
        P4Declaration("do_something", P4Function("do_something", return_type=z3.BitVecSort(8), params=[
            P4Parameter("inout", "some_input", z3.BitVecSort(8), None),],         body=BlockStatement([
            AssignmentStatement("some_input", z3.BitVecVal(1, 8)),
    ...
    prog_state.declare_global(
        ControlDeclaration(P4Control(
            ...
            const_params=[],
            body=BlockStatement([
                AssignmentStatement("val", z3.BitVecVal(3, 8)),
                BlockStatement([
                    AssignmentStatement("tmp", MethodCallExpr("do_something", [], "val", )),
                    AssignmentStatement("tmp_0", P4add("val", "tmp")),
                    AssignmentStatement(P4Member(P4Member("h", "h"), "a"), "tmp_0"),]
                ),]
            ),
            local_decls=[
ValueDeclaration("val", None, z3_type=z3.BitVecSort(8)), 
