...
def p4_program(prog_state):
    ...
    prog_state.declare_global(
        HeaderType("H", prog_state, fields=[("a", z3.BitVecSort(8)), ("b", z3.BitVecSort(8)), ("c", z3.BitVecSort(8)), ], type_params=[])
    )
    prog_state.declare_global(
    ...
    prog_state.declare_global(
        ControlDeclaration(P4Control(
            ...
            const_params=[],
            body=BlockStatement([
                ValueDeclaration("n", P4Initializer(z3.BitVecVal(255, 8), z3.BitVecSort(8)), z3_type=z3.BitVecSort(8)),
                ValueDeclaration("m", P4Initializer(z3.BitVecVal(255, 8), z3.BitVecSort(8)), z3_type=z3.BitVecSort(8)),
                ValueDeclaration("x", P4Initializer(z3.BitVecVal(255, 8), z3.BitVecSort(8)), z3_type=z3.BitVecSort(8)),
                AssignmentStatement(P4Slice(P4Slice(P4Slice(P4Slice("n", 6, 0), 6, 2), 4, 2), 2, 0), z3.BitVecVal(0, 3)),
                AssignmentStatement(P4Slice(P4Slice("m", 7, 4), 3, 1), z3.BitVecVal(0, 3)),
                AssignmentStatement(P4Slice(P4Slice("x", 5, 4), 1, 1), z3.BitVecVal(0, 1)),
                AssignmentStatement(P4Member(P4Member("headers", "h"), "a"), "n"),
                AssignmentStatement(P4Member(P4Member("headers", "h"), "b"), "m"),
                AssignmentStatement(P4Member(P4Member("headers", "h"), "c"), "x"),]
            ),
            local_decls=[]
        ))
    )
    ...
    prog_state.declare_global(
        InstanceDeclaration("main", "V1Switch", ConstCallExpr("P", ), ConstCallExpr("Verify", ), ConstCallExpr("Ing", ), ConstCallExpr("Eg", ), ConstCallExpr("Compute", ), ConstCallExpr("DP", ), )
    )
