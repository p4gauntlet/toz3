...
P4Declaration("c_t", P4Table("t", key=[(P4add(P4Member(P4Member("h", "h"), "a"), P4Member(P4Member("h", "h"), "a")), "exact"), ], actions=[MethodCallExpr("c_a_0", [], ), MethodCallExpr("NoAction_0", [], ), ], default_action=MethodCallExpr("NoAction_0", [], ), immutable=False)), ]
        ))
    )
    prog_state.declare_global(
