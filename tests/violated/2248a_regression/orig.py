...
P4Declaration("foo", P4Action("foo", params=[],                 body=BlockStatement([
                    ...
                    IfStatement(P4gt(P4Member(P4Member("hdr", "h"), "b"), z3.BitVecVal(10, 4)), BlockStatement([
                        AssignmentStatement(P4Member(P4Member("hdr", "h"), "b"), P4xor(P4Member(P4Member("hdr", "h"), "b"), z3.BitVecVal(5, 4))),
                        AssignmentStatement("hasReturned", z3.BoolVal(True)),]
                    ), P4Noop()),
                    IfStatement(P4not("hasReturned"), BlockStatement([
                        AssignmentStatement(P4Member(P4Member("hdr", "h"), "b"), P4add(P4Member(P4Member("hdr", "h"), "b"), z3.BitVecVal(5, 4))),]
                    ), P4Noop()),]
                )                )), ]
        ))
