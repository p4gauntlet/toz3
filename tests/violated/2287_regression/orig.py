...
def p4_program(prog_state):
    ...
    prog_state.declare_global(
        P4Declaration("do_function", P4Function("do_function", return_type=z3.BitVecSort(16), params=[
            ...
            AssignmentStatement("val", z3.BitVecVal(1, 16)),
    ...
    prog_state.declare_global(
        ControlDeclaration(P4Control(
            ...
            const_params=[],
            body=BlockStatement([
                ValueDeclaration("tmp", P4Initializer(P4Slice(P4Concat(P4Member(P4Member("h", "eth_hdr"), "eth_type"), MethodCallExpr("do_function", [], P4Member(P4Member("h", "eth_hdr"), "eth_type"), )), 31, 16), z3.BitVecSort(16)), z3_type=z3.BitVecSort(16)),]
            ),
            local_decls=[]
        ))
    )
