...
def p4_program(prog_state):
    ...
    prog_state.declare_global(
        ControlDeclaration(P4Control(
            ...
            const_params=[],
            body=BlockStatement([
                AssignmentStatement(P4Member(P4Member("h", "eth_hdr"), "src_addr"), z3.BitVecVal(2, 48)),
                AssignmentStatement(P4Member(P4Member("h", "eth_hdr"), "dst_addr"), z3.BitVecVal(2, 48)),
                AssignmentStatement(P4Member(P4Member("h", "eth_hdr"), "eth_type"), z3.BitVecVal(2, 16)),
                MethodCallStmt(MethodCallExpr("simple_action", [], )),]
            ),
            local_decls=[
ValueDeclaration("hasReturned", None, z3_type=z3.BoolSort()), 
ValueDeclaration("val_eth_hdr", None, z3_type="ethernet_t"), 
P4Declaration("simple_action", P4Action("simple_action", params=[],                 body=BlockStatement([
                    ...
                    BlockStatement([
                        ...
                        AssignmentStatement("cond", P4eq(P4Member(P4Member("h", "eth_hdr"), "eth_type"), z3.BitVecVal(1, 16))),
                        AssignmentStatement("hasReturned", P4Mux("cond", z3.BoolVal(True), "hasReturned")),]
                    ),
                    BlockStatement([
                        ValueDeclaration("cond_0", None, z3_type=z3.BoolSort()),
                        AssignmentStatement("cond_0", P4not("hasReturned")),
                        BlockStatement([
                            AssignmentStatement("val_eth_hdr", P4Mux("cond_0", P4Member("h", "eth_hdr"), "val_eth_hdr")),]
                        ),
                        AssignmentStatement(P4Member(P4Member("h", "eth_hdr"), "src_addr"), P4Mux("cond_0", z3.BitVecVal(1, 48), P4Member(P4Member("h", "eth_hdr"), "src_addr"))),
                        AssignmentStatement(P4Member("h", "eth_hdr"), P4Mux("cond_0", "val_eth_hdr", P4Member("h", "eth_hdr"))),]
                    ),]
                )                )), ]
        ))
    )
    ...
    prog_state.declare_global(
        ControlDeclaration(P4Control(
            ...
            body=BlockStatement([
                BlockStatement([
                    MethodCallStmt(MethodCallExpr(P4Member("b", "emit"), ["ethernet_t", ], P4Member("h", "eth_hdr"), )),]
                ),]
            ),
            local_decls=[]
        ))
