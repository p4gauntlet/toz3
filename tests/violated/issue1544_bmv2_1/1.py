    ...
    prog_state.declare_global(
        ControlDeclaration(P4Control(
            ...
            body=BlockStatement([
                ...
                BlockStatement([
                    ValueDeclaration("x_0", P4Initializer(P4Slice(P4Member(P4Member("hdr", "ethernet"), "srcAddr"), 15, 0), z3.BitVecSort(16)), z3_type=z3.BitVecSort(16)),
            ...
            local_decls=[
P4Declaration("my_drop", P4Action("my_drop", params=[
...
P4Declaration("set_port", P4Action("set_port", params=[
                    ...
                    AssignmentStatement(P4Member("standard_metadata", "egress_spec"), P4add("output_port", 1)),]
                )                )), 
P4Declaration("mac_da_0", P4Table("mac_da", key=[(P4Member(P4Member("hdr", "ethernet"), "dstAddr"), "exact"), ], actions=[MethodCallExpr("set_port", [], ), MethodCallExpr("my_drop", [], "standard_metadata", ), ], default_action=MethodCallExpr("my_drop", [], "standard_metadata", ), immutable=False)), ]
        ))
    )
    prog_state.declare_global(
        ControlDeclaration(P4Control(
