    ...
    prog_state.declare_global(
        ControlDeclaration(P4Control(
            ...
            body=BlockStatement([
                ...
                IfStatement(P4eq(P4Member("stdmeta", "parser_error"), z3.BitVecVal(1, 1)), BlockStatement([
                    AssignmentStatement(P4Member(P4Member("hdr", "ethernet"), "srcAddr"), z3.BitVecVal(2989, 48)),]
                ), P4Noop()),
                IfStatement(P4ne(P4Member("stdmeta", "checksum_error"), P4Member("error", "NoError")), BlockStatement([
                ...
                IfStatement(MethodCallExpr(P4Member(P4Member("hdr", "ipv4"), "isValid"), [], ), BlockStatement([
                    AssignmentStatement(P4Member(P4Member("hdr", "ipv4"), "ttl"), P4subsat(P4Member(P4Member("hdr", "ipv4"), "ttl"), z3.BitVecVal(1, 8))),]
                ), P4Noop()),]
            ),
            local_decls=[]
        ))
