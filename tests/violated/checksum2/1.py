    ...
    prog_state.declare_global(
        ControlDeclaration(P4Control(
            ...
            body=BlockStatement([
                ...
                IfStatement(P4eq(P4Member("stdmeta", "checksum_error"), 1), BlockStatement([
                    AssignmentStatement(P4Member(P4Member("hdr", "ethernet"), "srcAddr"), z3.BitVecVal(2989, 48)),]
                ), P4Noop()),
                IfStatement(P4ne(P4Member("stdmeta", "parser_error"), P4Member("error", "PacketTooShort")), BlockStatement([
