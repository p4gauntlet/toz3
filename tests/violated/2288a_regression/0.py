...
def p4_program(prog_state):
    ...
    prog_state.declare_global(
        P4Declaration("f", P4Function("f", return_type=z3.BitVecSort(8), params=[
            P4Parameter("inout", "x", z3.BitVecSort(8), None),
            P4Parameter("in", "z", z3.BitVecSort(8), None),],         body=BlockStatement([
            P4Return(z3.BitVecVal(4, 8)),]
        )        )        )
    )
    prog_state.declare_global(
        P4Declaration("g", P4Function("g", return_type=z3.BitVecSort(8), params=[
            P4Parameter("inout", "z", z3.BitVecSort(8), None),],         body=BlockStatement([
            AssignmentStatement("z", z3.BitVecVal(3, 8)),
        ...
        ControlDeclaration(P4Control(
            ...
            body=BlockStatement([
                BlockStatement([
                    ...
                    MethodCallStmt(MethodCallExpr("f", [], P4Member(P4Member("h", "h"), "a"), "tmp_0", )),]
                ),]
            ),
            local_decls=[
