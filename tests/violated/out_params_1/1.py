...
P4Declaration("tbl1_0", P4Table("tbl1", key=[(P4Member(P4Member("hdrs", "data"), "f2"), "exact"), ], actions=[MethodCallExpr("setbyte", [], P4Member(P4Member("hdrs", "data"), "b1"), ), MethodCallExpr("noop", [], ), ], default_action=MethodCallExpr("noop", [], ), immutable=False)), ]
        ))
    )
    prog_state.declare_global(
        ControlDeclaration(P4Control(
