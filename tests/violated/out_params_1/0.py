...
P4Declaration("tbl1_0", P4Table("tbl1", key=[(P4Member(P4Member("hdrs", "data"), "f2"), "exact"), ], actions=[], default_action=MethodCallExpr("setbyte", [], P4Member(P4Member("hdrs", "data"), "b2"), ), immutable=False)), ]
        ))
    )
    prog_state.declare_global(
        ControlDeclaration(P4Control(
