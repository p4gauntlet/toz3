...
P4Declaration("setbyte", P4Action("setbyte", params=[
                    P4Parameter("out", "reg", z3.BitVecSort(8), None),
                    P4Parameter("none", "val", z3.BitVecSort(8), None),],                 body=BlockStatement([
                    AssignmentStatement("reg", "val"),]
                )                )), 
P4Declaration("tbl1_0", P4Table("tbl1", key=[(P4Member(P4Member("hdrs", "data"), "f2"), "exact"), ], actions=[MethodCallExpr("setbyte", [], P4Slice(P4Member(P4Index(P4Member("hdrs", "extra"), 3), "h"), 15, 8), ), MethodCallExpr("noop", [], ), ], default_action=MethodCallExpr("noop", [], ), immutable=False)), ]
        ))
    )
    prog_state.declare_global(
        ControlDeclaration(P4Control(
