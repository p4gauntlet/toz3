...
P4Declaration("simple_action", P4Action("simple_action", params=[],                 body=BlockStatement([
                    IfStatement(P4ne(P4Member(P4Member("h", "eth_hdr"), "eth_type"), z3.BitVecVal(0, 16)), BlockStatement([
                        IfStatement(P4ne(P4Member(P4Member("h", "eth_hdr"), "src_addr"), z3.BitVecVal(0, 48)), BlockStatement([
                            AssignmentStatement("tmp", z3.BitVecVal(1, 48)),]
                        ), BlockStatement([
                            AssignmentStatement("tmp", z3.BitVecVal(2, 48)),]
                        )),
                        AssignmentStatement("tmp_val_0", "tmp"),
                        AssignmentStatement(P4Member(P4Member("h", "eth_hdr"), "dst_addr"), "tmp_val_0"),]
                    ), P4Noop()),]
                )                )), ]
        ))
    )
