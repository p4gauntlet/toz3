...
def p4_program(prog_state):
    ...
    prog_state.declare_global(
        ControlDeclaration(P4Control(
            ...
            const_params=[],
            body=BlockStatement([
                MethodCallStmt(MethodCallExpr("dummy_action_0", [], P4Member(P4Member("h", "eth_hdr"), "eth_type"), P4Mux(P4Member(MethodCallExpr(P4Member("simple_table_0", "apply"), [], ), "hit"), z3.BitVecVal(1, 16), z3.BitVecVal(2, 16)), )),]
            ),
            local_decls=[
