...
def p4_program(prog_state):
    ...
    prog_state.declare_global(
        ControlDeclaration(P4Control(
            ...
            const_params=[],
            body=BlockStatement([
                SwitchStatement(P4Member(MethodCallExpr(P4Member("simple_table_0", "apply"), [], ), "action_run"),cases=[("NoAction_0", BlockStatement([]
                )), ]),
                IfStatement(P4not(z3.BoolVal(True)), BlockStatement([
