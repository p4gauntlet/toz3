...
P4Declaration("t_exact_0", P4Table("t_exact", key=[(P4Member(P4Member("h", "h"), "e"), "exact"), ], actions=[MethodCallExpr("a", [], ), MethodCallExpr("a_with_control_params", [], ), ], default_action=MethodCallExpr("a", [], ), entries=[([z3.BitVecVal(1, 8), ], MethodCallExpr("a_with_control_params", [], z3.BitVecVal(2, 9), )), ([z3.BitVecVal(2, 8), ], MethodCallExpr("a_with_control_params", [], z3.BitVecVal(2, 9), )), ], immutable=True)), ]
        ))
    )
    prog_state.declare_global(
