...
P4Declaration("t_exact_0", P4Table("t_exact", key=[(P4Member(P4Member("h", "h"), "e"), "exact"), ], actions=[MethodCallExpr("a", [], ), MethodCallExpr("a_with_control_params", [], ), ], default_action=MethodCallExpr("a", [], ), immutable=False)), ]
        ))
    )
    prog_state.declare_global(
