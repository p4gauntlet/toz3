...
def p4_program(prog_state):
    ...
    prog_state.declare_global(
        P4Declaration("do_function", P4Function("do_function", return_type=z3.BitVecSort(16), params=[
            P4Parameter("inout", "val", z3.BitVecSort(16), None),],         body=BlockStatement([
            AssignmentStatement("val", z3.BitVecVal(182, 16)),
            P4Return(z3.BitVecVal(2, 16)),]
        )        )        )
    )
    prog_state.declare_global(
    ...
    prog_state.declare_global(
        ControlDeclaration(P4Control(
            ...
            body=BlockStatement([
                BlockStatement([
                    AssignmentStatement("tmp", MethodCallExpr("do_function", [], P4Member(P4Member("h", "eth_hdr"), "eth_type"), )),
                    AssignmentStatement("tmp_0", P4eq(P4Member(P4Member("h", "eth_hdr"), "eth_type"), "tmp")),
                    IfStatement("tmp_0", BlockStatement([
...
ValueDeclaration("tmp_0", None, z3_type=z3.BoolSort()), ]
        ))
    )
    prog_state.declare_global(
        ControlDeclaration(P4Control(
