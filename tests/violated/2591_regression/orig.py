...
def p4_program(prog_state):
    ...
    prog_state.declare_global(
        ControlDeclaration(P4Parser(
            ...
            local_decls=[],
            body=ParserTree([
                ParserState(name="start", select=ParserSelect([P4Member(P4Member("hdr", "h"), "a"), ], [(P4Range(z3.BitVecVal(4, 4), z3.BitVecVal(7, 4)), "reject"), (P4Range(z3.BitVecVal(1, 4), z3.BitVecVal(3, 4)), "accept"), (DefaultExpression(), "reject"), ]),
                components=[
