...
def p4_program(prog_state):
    ...
    prog_state.declare_global(
        ControlDeclaration(P4Control(
            ...
            const_params=[],
            body=BlockStatement([
                AssignmentStatement("tmp_0", P4Cast(P4Initializer([P4Cast(P4Initializer([P4Member(P4Member("h", "eth_hdr"), "dst_addr"), MethodCallExpr("set", [], P4Member(P4Member("h", "eth_hdr"), "dst_addr"), ), z3.BitVecVal(1, 16), ], ), "ethernet_t"), ], ), "Headers")),
