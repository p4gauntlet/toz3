...
P4Declaration("ipv4_fib_lpm_0", P4Table("ipv4_fib_lpm", actions=[MethodCallExpr("on_miss_5", [], ), ], key=[(P4Member(P4Member("meta", "ingress_metadata"), "vrf"), "exact"), (P4Member(P4Member("hdr", "ipv4"), "dstAddr"), "lpm"), ], size=16384, default_action=MethodCallExpr("NoAction_9", [], ), immutable=False)), ]
        ))
    )
    prog_state.declare_global(
        ControlDeclaration(P4Control(
