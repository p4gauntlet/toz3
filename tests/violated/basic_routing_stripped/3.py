...
P4Declaration("ipv4_fib_0", P4Table("ipv4_fib", actions=[MethodCallExpr("on_miss_2", [], ), MethodCallExpr("fib_hit_nexthop", [], ), ], key=[(P4Member(P4Member("meta", "ingress_metadata"), "vrf"), "exact"), ], size=131072, default_action=MethodCallExpr("NoAction_8", [], ), immutable=False)), 
