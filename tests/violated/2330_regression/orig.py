...
P4Declaration("do_action", P4Action("do_action", params=[],                 body=BlockStatement([
                    ...
                    IfStatement(P4ne(P4Member(P4Member("h", "eth_hdr"), "dst_addr"), z3.BitVecVal(0, 48)), BlockStatement([
                        P4Noop(),]
                    ), BlockStatement([
                    ...
                    IfStatement(P4not("hasReturned"), BlockStatement([
                        BlockStatement([
                            AssignmentStatement("val_0", P4Member(P4Member("h", "eth_hdr"), "eth_type")),
                            AssignmentStatement(P4Member(P4Member("h", "eth_hdr"), "eth_type"), "val_0"),]
                        ),
                        IfStatement("pointless_bool_0", BlockStatement([
                            AssignmentStatement("tmp", z3.BitVecVal(1, 48)),]
                        ), BlockStatement([
                            AssignmentStatement("tmp", z3.BitVecVal(2, 48)),]
                        )),
                        AssignmentStatement(P4Member(P4Member("h", "eth_hdr"), "src_addr"), "tmp"),]
                    ), P4Noop()),]
                )                )), ]
        ))
    )
