    ...
    prog_state.declare_global(
        ControlDeclaration(P4Control(
            ...
            body=BlockStatement([
                ...
                AssignmentStatement("dummy_var", P4band(z3.BitVecVal(0, 8), MethodCallExpr("function_with_side_effect", [], P4Member(P4Member("h", "h"), "a"), ))),
                AssignmentStatement("dummy_var", P4mul(z3.BitVecVal(0, 8), MethodCallExpr("function_with_side_effect", [], P4Member(P4Member("h", "h"), "b"), ))),
                AssignmentStatement("dummy_var", P4div(z3.BitVecVal(0, 8), MethodCallExpr("function_with_side_effect", [], P4Member(P4Member("h", "h"), "c"), ))),
                AssignmentStatement("dummy_var", P4rshift(z3.BitVecVal(0, 8), MethodCallExpr("function_with_side_effect", [], P4Member(P4Member("h", "h"), "d"), ))),
                AssignmentStatement("dummy_var", P4lshift(z3.BitVecVal(0, 8), MethodCallExpr("function_with_side_effect", [], P4Member(P4Member("h", "h"), "e"), ))),
                AssignmentStatement("dummy_var", P4mod(z3.BitVecVal(0, 8), MethodCallExpr("function_with_side_effect", [], P4Member(P4Member("h", "h"), "f"), ))),
                AssignmentStatement("dummy_var", P4xor(z3.BitVecVal(0, 8), MethodCallExpr("function_with_side_effect", [], P4Member(P4Member("h", "h"), "g"), ))),
                ...
                AssignmentStatement("dummy_var", P4sub(z3.BitVecVal(0, 8), MethodCallExpr("function_with_side_effect", [], P4Member(P4Member("h", "h"), "l"), ))),
                AssignmentStatement("dummy_var", P4Slice(P4Concat(z3.BitVecVal(1, 16), MethodCallExpr("function_with_side_effect", [], P4Member(P4Member("h", "h"), "m"), )), 15, 8)),
