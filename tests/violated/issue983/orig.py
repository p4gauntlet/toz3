...
def p4_program(prog_state):
    ...
    prog_state.declare_global(
        TypeDeclaration("EthernetAddress", z3.BitVecSort(48))
    )
    prog_state.declare_global(
        HeaderType("ethernet_t", prog_state, fields=[("dstAddr", "EthernetAddress"), ("srcAddr", "EthernetAddress"), ("etherType", z3.BitVecSort(16)), ], type_params=[])
    )
    prog_state.declare_global(
        StructType("fwd_meta_t", prog_state, fields=[("tmp", z3.BitVecSort(16)), ("x1", z3.BitVecSort(32)), ("x2", z3.BitVecSort(16)), ("x3", z3.BitVecSort(32)), ("x4", z3.BitVecSort(32)), ("exp_etherType", z3.BitVecSort(16)), ("exp_x1", z3.BitVecSort(32)), ("exp_x2", z3.BitVecSort(16)), ("exp_x3", z3.BitVecSort(32)), ("exp_x4", z3.BitVecSort(32)), ], type_params=[])
    )
    prog_state.declare_global(
        StructType("metadata", prog_state, fields=[("fwd_meta", "fwd_meta_t"), ], type_params=[])
    )
    prog_state.declare_global(
    ...
    prog_state.declare_global(
        ControlDeclaration(P4Parser(
            name="IngressParserImpl",
            type_params=[],
            params=[
                P4Parameter("none", "buffer", "packet_in", None),
                P4Parameter("out", "hdr", "headers", None),
                P4Parameter("inout", "user_meta", "metadata", None),
                P4Parameter("inout", "standard_metadata", "standard_metadata_t", None),],
            const_params=[],
            local_decls=[],
            body=ParserTree([
                ...
                components=[
                MethodCallStmt(MethodCallExpr(P4Member("buffer", "extract"), [], P4Member("hdr", "ethernet"), )),                ]),
                ])
))
    )
    prog_state.declare_global(
        ControlDeclaration(P4Control(
            ...
            const_params=[],
            body=BlockStatement([
                AssignmentStatement("tmp", P4inv(P4Member(P4Member("hdr", "ethernet"), "etherType"))),
                AssignmentStatement("x1", P4Cast("tmp", z3.BitVecSort(32))),
                AssignmentStatement("x2", P4add(P4Slice("x1", 31, 16), P4Slice("x1", 15, 0))),
                AssignmentStatement(P4Member(P4Member("user_meta", "fwd_meta"), "tmp"), "tmp"),
                AssignmentStatement(P4Member(P4Member("user_meta", "fwd_meta"), "x1"), "x1"),
                AssignmentStatement(P4Member(P4Member("user_meta", "fwd_meta"), "x2"), "x2"),
                AssignmentStatement(P4Member(P4Member("user_meta", "fwd_meta"), "x3"), P4Cast(P4inv(P4Member(P4Member("hdr", "ethernet"), "etherType")), z3.BitVecSort(32))),
                AssignmentStatement(P4Member(P4Member("user_meta", "fwd_meta"), "x4"), P4inv(P4Cast(P4Member(P4Member("hdr", "ethernet"), "etherType"), z3.BitVecSort(32)))),
                AssignmentStatement(P4Member(P4Member("user_meta", "fwd_meta"), "exp_etherType"), 2048),
                AssignmentStatement(P4Member(P4Member("user_meta", "fwd_meta"), "exp_x1"), P4Cast(P4inv(z3.BitVecVal(2048, 16)), z3.BitVecSort(32))),
                AssignmentStatement(P4Member(P4Member("user_meta", "fwd_meta"), "exp_x2"), P4inv(z3.BitVecVal(2048, 16))),
                AssignmentStatement(P4Member(P4Member("user_meta", "fwd_meta"), "exp_x3"), P4Cast(P4inv(z3.BitVecVal(2048, 16)), z3.BitVecSort(32))),
                AssignmentStatement(P4Member(P4Member("user_meta", "fwd_meta"), "exp_x4"), P4inv(z3.BitVecVal(2048, 32))),
                AssignmentStatement(P4Member(P4Member("hdr", "ethernet"), "dstAddr"), 0),
                IfStatement(P4ne(P4Member(P4Member("hdr", "ethernet"), "etherType"), P4Member(P4Member("user_meta", "fwd_meta"), "exp_etherType")), BlockStatement([
                    AssignmentStatement(P4Slice(P4Member(P4Member("hdr", "ethernet"), "dstAddr"), 47, 40), 1),]
                ), P4Noop()),
                IfStatement(P4ne(P4Member(P4Member("user_meta", "fwd_meta"), "x1"), P4Member(P4Member("user_meta", "fwd_meta"), "exp_x1")), BlockStatement([
                    AssignmentStatement(P4Slice(P4Member(P4Member("hdr", "ethernet"), "dstAddr"), 39, 32), 1),]
                ), P4Noop()),
                IfStatement(P4ne(P4Member(P4Member("user_meta", "fwd_meta"), "x2"), P4Member(P4Member("user_meta", "fwd_meta"), "exp_x2")), BlockStatement([
                    AssignmentStatement(P4Slice(P4Member(P4Member("hdr", "ethernet"), "dstAddr"), 31, 24), 1),]
                ), P4Noop()),
                IfStatement(P4ne(P4Member(P4Member("user_meta", "fwd_meta"), "x3"), P4Member(P4Member("user_meta", "fwd_meta"), "exp_x3")), BlockStatement([
                    AssignmentStatement(P4Slice(P4Member(P4Member("hdr", "ethernet"), "dstAddr"), 23, 16), 1),]
                ), P4Noop()),
                IfStatement(P4ne(P4Member(P4Member("user_meta", "fwd_meta"), "x4"), P4Member(P4Member("user_meta", "fwd_meta"), "exp_x4")), BlockStatement([
                    AssignmentStatement(P4Slice(P4Member(P4Member("hdr", "ethernet"), "dstAddr"), 15, 8), 1),]
                ), P4Noop()),
                MethodCallStmt(MethodCallExpr(P4Member("debug_table_cksum1", "apply"), [], )),]
            ),
            local_decls=[
P4Declaration("do_something", P4Action("do_something", params=[],                 body=BlockStatement([
                    AssignmentStatement(P4Member("standard_metadata", "egress_spec"), 0),]
                )                )), 
P4Declaration("debug_table_cksum1", P4Table("debug_table_cksum1", key=[(P4Member(P4Member("hdr", "ethernet"), "srcAddr"), "exact"), (P4Member(P4Member("hdr", "ethernet"), "dstAddr"), "exact"), (P4Member(P4Member("hdr", "ethernet"), "etherType"), "exact"), (P4Member(P4Member("user_meta", "fwd_meta"), "exp_etherType"), "exact"), (P4Member(P4Member("user_meta", "fwd_meta"), "tmp"), "exact"), (P4Member(P4Member("user_meta", "fwd_meta"), "exp_x1"), "exact"), (P4Member(P4Member("user_meta", "fwd_meta"), "x1"), "exact"), (P4Member(P4Member("user_meta", "fwd_meta"), "exp_x2"), "exact"), (P4Member(P4Member("user_meta", "fwd_meta"), "x2"), "exact"), (P4Member(P4Member("user_meta", "fwd_meta"), "exp_x3"), "exact"), (P4Member(P4Member("user_meta", "fwd_meta"), "x3"), "exact"), (P4Member(P4Member("user_meta", "fwd_meta"), "exp_x4"), "exact"), (P4Member(P4Member("user_meta", "fwd_meta"), "x4"), "exact"), ], actions=["NoAction", "do_something", ], immutable=False)), 
ValueDeclaration("tmp", None, z3_type=z3.BitVecSort(16)), 
ValueDeclaration("x1", None, z3_type=z3.BitVecSort(32)), 
ValueDeclaration("x2", None, z3_type=z3.BitVecSort(16)), ]
        ))
    )
    prog_state.declare_global(
        ControlDeclaration(P4Control(
    ...
    prog_state.declare_global(
        ControlDeclaration(P4Control(
            ...
            const_params=[],
            body=BlockStatement([
                MethodCallStmt(MethodCallExpr(P4Member("packet", "emit"), [], P4Member("hdr", "ethernet"), )),]
            ),
            local_decls=[]
        ))
    )
    ...
    prog_state.declare_global(
        InstanceDeclaration("main", "V1Switch", ConstCallExpr("IngressParserImpl", ), ConstCallExpr("verifyChecksum", ), ConstCallExpr("ingress", ), ConstCallExpr("egress", ), ConstCallExpr("computeChecksum", ), ConstCallExpr("DeparserImpl", ), )
    )
