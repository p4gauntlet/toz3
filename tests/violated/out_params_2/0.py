...
def p4_program(prog_state):
    ...
    prog_state.declare_global(
        HeaderType("data_h", prog_state, fields=[("f1", z3.BitVecSort(32)), ("f2", z3.BitVecSort(32)), ("h1", z3.BitVecSort(16)), ("b1", z3.BitVecSort(8)), ("b2", z3.BitVecSort(8)), ], type_params=[])
    )
    prog_state.declare_global(
        HeaderType("extra_h", prog_state, fields=[("h", z3.BitVecSort(16)), ("b1", z3.BitVecSort(8)), ("b2", z3.BitVecSort(8)), ], type_params=[])
    )
    prog_state.declare_global(
        StructType("packet_t", prog_state, fields=[("data", "data_h"), ("extra", prog_state.stack("extra_h", 4)), ], type_params=[])
    )
    prog_state.declare_global(
    ...
    prog_state.declare_global(
        ControlDeclaration(P4Parser(
            ...
            params=[
                P4Parameter("none", "b", "packet_in", None),
                P4Parameter("out", "hdrs", "packet_t", None),
                P4Parameter("inout", "m", "Meta", None),
                P4Parameter("inout", "meta", "standard_metadata_t", None),],
            const_params=[],
            local_decls=[],
            body=ParserTree([
                ParserState(name="start", select="extra",
                components=[
                MethodCallStmt(MethodCallExpr(P4Member("b", "extract"), ["data_h", ], P4Member("hdrs", "data"), )),                ]),
                ParserState(name="extra", select=ParserSelect([P4Member(P4Member(P4Member("hdrs", "extra"), "last"), "b2"), ], [(P4Mask(z3.BitVecVal(128, 8), z3.BitVecVal(128, 8)), "extra"), (DefaultExpression(), "accept"), ]),
                components=[
                MethodCallStmt(MethodCallExpr(P4Member("b", "extract"), ["extra_h", ], P4Member(P4Member("hdrs", "extra"), "next"), )),                ]),
                ])
))
    )
    prog_state.declare_global(
        ControlDeclaration(P4Control(
            ...
            type_params=[],
            params=[
                P4Parameter("inout", "h", "packet_t", None),
                P4Parameter("inout", "m", "Meta", None),],
            const_params=[],
            body=BlockStatement([]
            ),
    ...
    prog_state.declare_global(
        ControlDeclaration(P4Control(
            ...
            type_params=[],
            params=[
                P4Parameter("inout", "hdrs", "packet_t", None),
                P4Parameter("inout", "m", "Meta", None),
                P4Parameter("inout", "meta", "standard_metadata_t", None),],
            const_params=[],
            body=BlockStatement([
                MethodCallStmt(MethodCallExpr(P4Member("tbl1_0", "apply"), [], )),]
            ),
            local_decls=[
P4Declaration("noop", P4Action("noop", params=[],                 body=BlockStatement([]
                )                )), 
ValueDeclaration("reg", None, z3_type=z3.BitVecSort(8)), 
P4Declaration("setbyte", P4Action("setbyte", params=[
                    P4Parameter("none", "val", z3.BitVecSort(8), None),],                 body=BlockStatement([
                    AssignmentStatement("reg", P4add("val", 1)),
                    AssignmentStatement(P4Member(P4Member("hdrs", "data"), "b2"), "reg"),]
                )                )), 
P4Declaration("tbl1_0", P4Table("tbl1", key=[(P4Member(P4Member("hdrs", "data"), "f2"), "exact"), ], actions=[MethodCallExpr("setbyte", [], ), MethodCallExpr("noop", [], ), ], default_action=MethodCallExpr("noop", [], ), immutable=False)), ]
        ))
    )
    prog_state.declare_global(
        ControlDeclaration(P4Control(
    ...
    prog_state.declare_global(
        ControlDeclaration(P4Control(
            ...
            params=[
                P4Parameter("none", "b", "packet_out", None),
                P4Parameter("in", "hdrs", "packet_t", None),],
            const_params=[],
            body=BlockStatement([
                MethodCallStmt(MethodCallExpr(P4Member("b", "emit"), ["data_h", ], P4Member("hdrs", "data"), )),
                MethodCallStmt(MethodCallExpr(P4Member("b", "emit"), [prog_state.stack("extra_h", 4), ], P4Member("hdrs", "extra"), )),]
            ),
            local_decls=[]
        ))
    )
    prog_state.declare_global(
        InstanceDeclaration("main", TypeSpecializer("V1Switch", "packet_t", "Meta", ), ConstCallExpr("p", ), ConstCallExpr("vrfy", ), ConstCallExpr("ingress", ), ConstCallExpr("egress", ), ConstCallExpr("update", ), ConstCallExpr("deparser", ), )
    )
