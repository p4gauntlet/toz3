...
def p4_program(prog_state):
    ...
    prog_state.declare_global(
        StructType("H", prog_state, fields=[], type_params=[])
    )
    prog_state.declare_global(
    ...
    prog_state.declare_global(
        ControlDeclaration(P4Parser(
            ...
            params=[
                ...
                P4Parameter("inout", "meta", "M", None),
                P4Parameter("inout", "smeta", "standard_metadata_t", None),],
            const_params=[],
            local_decls=[],
            body=ParserTree([
    ...
    prog_state.declare_global(
        ControlDeclaration(P4Control(
            ...
            const_params=[],
            body=BlockStatement([
                MethodCallStmt(MethodCallExpr(P4Member("forward_0", "apply"), [], )),
                AssignmentStatement(P4Member("smeta", "egress_spec"), 9),]
            ),
            local_decls=[
P4Declaration("drop", P4Action("drop", params=[
                    P4Parameter("inout", "smeta", "standard_metadata_t", None),],                 body=BlockStatement([
                    MethodCallStmt(MethodCallExpr("mark_to_drop", [], "smeta", )),]
                )                )), 
P4Declaration("forward_0", P4Table("forward", key=[], actions=[MethodCallExpr("drop", [], "smeta", ), ], default_action=MethodCallExpr("drop", [], "smeta", ), immutable=False)), ]
        ))
    )
    prog_state.declare_global(
        ControlDeclaration(P4Control(
    ...
    prog_state.declare_global(
        ControlDeclaration(P4Control(
            ...
            type_params=[],
            params=[
                P4Parameter("none", "pk", "packet_out", None),
    ...
    prog_state.declare_global(
        InstanceDeclaration("main", TypeSpecializer("V1Switch", "H", "M", ), ConstCallExpr("ParserI", ), ConstCallExpr("VerifyChecksumI", ), ConstCallExpr("IngressI", ), ConstCallExpr("EgressI", ), ConstCallExpr("ComputeChecksumI", ), ConstCallExpr("DeparserI", ), )
    )
