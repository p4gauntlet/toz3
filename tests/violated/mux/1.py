...
def p4_program(prog_state):
    ...
    prog_state.declare_global(
        StructType("Headers", prog_state, fields=[("a", z3.BitVecSort(64)), ("b", z3.BitVecSort(32)), ("c", z3.BitVecSort(32)), ], type_params=[])
    )
    prog_state.declare_global(
    ...
    prog_state.declare_global(
        ControlDeclaration(P4Parser(
            ...
            params=[
                P4Parameter("none", "b", "packet_in", None),
                P4Parameter("out", "p", "Headers", None),
                P4Parameter("inout", "meta", "Metadata", None),
                P4Parameter("inout", "standard_meta", "standard_metadata_t", None),],
            const_params=[],
            local_decls=[],
            body=ParserTree([
    ...
    prog_state.declare_global(
        ControlDeclaration(P4Control(
            ...
            type_params=[],
            params=[
                P4Parameter("inout", "headers", "Headers", None),
                P4Parameter("inout", "meta", "Metadata", None),
                P4Parameter("inout", "standard_meta", "standard_metadata_t", None),],
            const_params=[],
            body=BlockStatement([
                AssignmentStatement("res_0", z3.BitVecVal(0, 64)),
                MethodCallStmt(MethodCallExpr("update", [], )),
                AssignmentStatement(P4Member("headers", "a"), "res_0"),]
            ),
            local_decls=[
ValueDeclaration("_sub_0", None, z3_type=z3.BitVecSort(32)), 
ValueDeclaration("res_0", None, z3_type=z3.BitVecSort(64)), 
ValueDeclaration("tmp", None, z3_type=z3.BitVecSort(32)), 
ValueDeclaration("p_1", None, z3_type=z3.BoolSort()), 
ValueDeclaration("val", None, z3_type=z3.BitVecSort(64)), 
P4Declaration("update", P4Action("update", params=[],                 body=BlockStatement([
                    AssignmentStatement("p_1", z3.BoolVal(True)),
                    AssignmentStatement("val", "res_0"),
                    AssignmentStatement("_sub_0", P4Slice("val", 31, 0)),
                    BlockStatement([
                        ValueDeclaration("cond", None, z3_type=z3.BoolSort()),
                        BlockStatement([
                            ValueDeclaration("pred", None, z3_type=z3.BoolSort()),
                            AssignmentStatement("cond", "p_1"),
                            AssignmentStatement("pred", "cond"),
                            AssignmentStatement("tmp", P4Mux("pred", "_sub_0", "tmp")),
                            AssignmentStatement("cond", P4not("cond")),
                            AssignmentStatement("pred", "cond"),
                            AssignmentStatement("tmp", P4Mux("pred", "tmp", z3.BitVecVal(1, 32))),]
                        ),]
                    ),
                    AssignmentStatement("_sub_0", "tmp"),
                    AssignmentStatement(P4Slice("val", 31, 0), "_sub_0"),
                    AssignmentStatement("res_0", "val"),]
                )                )), ]
        ))
    )
    prog_state.declare_global(
        ControlDeclaration(P4Control(
            ...
            type_params=[],
            params=[
                P4Parameter("inout", "hdrs", "Headers", None),
                P4Parameter("inout", "meta", "Metadata", None),
                P4Parameter("inout", "standard_meta", "standard_metadata_t", None),],
            const_params=[],
            body=BlockStatement([]
    ...
    prog_state.declare_global(
        InstanceDeclaration("main", TypeSpecializer("V1Switch", "Headers", "Metadata", ), ConstCallExpr("P", ), ConstCallExpr("Verify", ), ConstCallExpr("Ing", ), ConstCallExpr("Eg", ), ConstCallExpr("Compute", ), ConstCallExpr("DP", ), )
    )
