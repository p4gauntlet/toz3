...
P4Declaration("simple_action", P4Action("simple_action", params=[],                 body=BlockStatement([
                    IfStatement(P4ne(P4Member(P4Member("h", "eth_hdr"), "src_addr"), P4Member(P4Member("h", "eth_hdr"), "dst_addr")), BlockStatement([
                        AssignmentStatement(P4Member(P4Index(P4Member("h", "h"), 0), "a"), z3.BitVecVal(2, 8)),]
                    ), BlockStatement([
                        AssignmentStatement(P4Member(P4Index(P4Member("h", "h"), 1), "a"), z3.BitVecVal(1, 8)),]
                    )),]
                )                )), ]
        ))
    )
