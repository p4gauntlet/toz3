    ...
    prog_state.declare_global(
        ControlDeclaration(P4Control(
            ...
            body=BlockStatement([
                ...
                IfStatement(P4eq(P4Member(P4Member("hdr", "h"), "s"), P4Member(P4Index(P4Member("hdr", "a"), 1), "s")), BlockStatement([
