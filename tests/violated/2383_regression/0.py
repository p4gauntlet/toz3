        ...
        ControlDeclaration(P4Control(
            ...
            body=BlockStatement([
                BlockStatement([
                    ...
                    BlockStatement([
                        AssignmentStatement(P4Member("retval", "dst_addr"), z3.BitVecVal(1, 48)),
                        AssignmentStatement(P4Member("retval", "src_addr"), z3.BitVecVal(1, 48)),
                        AssignmentStatement(P4Member("retval", "eth_type"), z3.BitVecVal(1, 16)),]
                    ),
                    AssignmentStatement(P4Member("h", "eth_hdr"), "retval"),]
                ),]
            ),
            local_decls=[
ValueDeclaration("hasReturned", None, z3_type=z3.BoolSort()), 
ValueDeclaration("retval", None, z3_type="ethernet_t"), ]
        ))
    )
    prog_state.declare_global(
        ControlDeclaration(P4Control(
